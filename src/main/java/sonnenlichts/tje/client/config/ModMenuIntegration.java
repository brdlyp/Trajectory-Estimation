...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private Screen createConfigScreen(Screen parent) {
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setTitle(Component.translatable("config.trajectory_estimation.title"));

        ConfigEntryBuilder entryBuilder = builder.entryBuilder();

        // General category
        ConfigCategory general = builder.getOrCreateCategory(Component.translatable("config.trajectory_estimation.general"));

        general.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_point"),
        ...
        general.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.target_sound"),
        ...
        general.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_cube"),
        ...
        general.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_line"),
        ...
        // Cube appearance
        ConfigCategory cubeAppearance = builder.getOrCreateCategory(Component.translatable("config.trajectory_estimation.cube_appearance"));

        cubeAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.cube_red"),
        ...
        cubeAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.cube_green"),
        ...
        cubeAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.cube_blue"),
        ...
        cubeAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.cube_alpha"),
        ...
        cubeAppearance.addEntry(entryBuilder.startDoubleField(
                        Component.translatable("config.trajectory_estimation.cube_size"),
        ...
        // Line appearance
        ConfigCategory lineAppearance = builder.getOrCreateCategory(Component.translatable("config.trajectory_estimation.line_appearance"));

        lineAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.line_red"),
        ...
        lineAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.line_green"),
        ...
        lineAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.line_blue"),
        ...
        lineAppearance.addEntry(entryBuilder.startIntSlider(
                        Component.translatable("config.trajectory_estimation.line_alpha"),
        ...
        lineAppearance.addEntry(entryBuilder.startDoubleField(
                        Component.translatable("config.trajectory_estimation.line_width"),
        ...
        // Vanilla items
        ConfigCategory vanillaItems = builder.getOrCreateCategory(Component.translatable("config.trajectory_estimation.vanilla_items"));

        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_bow"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_crossbow"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_trident"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_snowball"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_egg"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_enderpearl"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_splash_bottle"),
        ...
        vanillaItems.addEntry(entryBuilder.startBooleanToggle(
                        Component.translatable("config.trajectory_estimation.render_experience_bottle"),
